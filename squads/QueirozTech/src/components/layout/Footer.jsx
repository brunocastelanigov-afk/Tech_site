        ...
        <footer className="footer">
            <div className="footer__inner">
                ...
                <div className="footer__social">
                    {/* Instagram */}
                    <a href="https://www.instagram.com/queiroztech.oficial/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                    ...
                    {/* LinkedIn */}
                    <a href="https://www.linkedin.com/company/queiroztech/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
