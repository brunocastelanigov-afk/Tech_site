...
const services = [
    {
        icon: assetUrl('imgs/server_1.png'),
    ...
    {
        icon: assetUrl('imgs/cloud_1.png'),
    ...
    {
        icon: assetUrl('imgs/hardware_1.png'),
    ...
    {
        icon: assetUrl('imgs/cheet_1.png'),
    ...
    {
        icon: assetUrl('imgs/graphic_1.png'),
    ...
    {
        icon: assetUrl('imgs/enginer_1.png'),
    ...
    {
        icon: assetUrl('imgs/secure_1.png'),
